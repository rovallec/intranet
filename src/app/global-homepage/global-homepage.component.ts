  ...
  ngOnInit(): void {
    this.articles = [
      ...
      },
      {
        ...
        article:"We welcome and love the many personalities, backgrounds and stories that make-up Nearsol´s staff. We work hard to build a diverse and inclusive environment where everyone has the opportunity to learn and grow. ",
        author:'Human Resources',
        date:"June 17, 2021",
        url: '',
        origin:"Colombia"
